...
function countVotes($connexion,$IdStagiaire)
{
    $query = "SELECT COUNT(*) as total FROM votestagiaire WHERE IdStagiaire=:IdStagiaire";
    $pdostmt = $connexion->prepare($query);
    $pdostmt->execute([
    ...
    <div class="app-container">
        ...
        <section class="hero">
            ...
            <div class="hero-stats">
                ...
                <div class="stat-item">
                    <div class="stat-value"><?php echo countVotes($connexion,$IdStagiaire)?></div>
