...
<body>
    ...
    <main class="main-content">
        ...
        $query1 = "SELECT * FROM  votejury WHERE IdProject = $IdProject";
        $pdostmt1 = $connexion->prepare($query); // Objet (instance) de PDOStatement
        $pdostmt1->execute([
            ':IdProject' => $IdProject
        ]);
        $stagiaires1 = $pdostmt1->fetch(PDO::FETCH_ASSOC);
        ...
        function nombreVote($connexion,$Id){
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_vote'])) {
            ...
            $IdProject = $_GET['id'];
            $Idjury = 1;
            $query = "INSERT INTO votejury (Idjury, Idprojet, score, comments, pup) VALUES (:Idjury, :IdProject, :score, :comment, :pup)";
            $pdostmt = $connexion->prepare($query);
            $pdostmt->execute([
                ':Idjury' => $Idjury,
                ':IdProject' => $IdProject,
        ...
        <div class="project-container">
            <div class="project-main">
                <div class="card">
                        ...
                        <div>
                            ...
                            <div class="project-meta">
                                ...
                                <div class="meta-item">
                                    ...
                                    Votes: <?php echo nombreVote($connexion,$IdProject) ?>
                                </div>
                            ...
                            <div class="jury-note">
                                <div class="jury-note-header">
                                    ...
                                    <div class="jury-rating">
                                        <span style="font-weight: bold; color: #eab308;">17/20</span>
                                    </div>
                                </div>
                    ...
                    <form method="post">
                        <h3 class="card-title" style="margin-top: 1.5rem;">Rate This Project</h3>
                        <div class="form-group">
                            <label  class="form-label">Rating (0-20)</label>
                            <input name="score" type="range" min="0" max="20" value="10" class="form-input" id="rating-range">
                            <div style="display: flex; justify-content: space-between; margin-top: 0.5rem;">
                                <span>0</span>
                                <span id="rating-value">10</span>
                                <span>20</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Comments</label>
                            <textarea name="comment" class="form-input" rows="4" placeholder="Enter your feedback and comments..."></textarea>
                        </div>
                        <button name="submit_vote" type="submit" class="btn btn-primary">Submit Rating</button>
                    </form>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div style="padding: 1rem;">
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        ...
                        <span style="color: #f8fafc;"><?php echo nombreVote($connexion, $IdProject)?></span>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Remove the validate and reject button event listeners since we removed the buttons
